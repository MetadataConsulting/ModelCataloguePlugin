...
if [ "$1" = "start" ] ; then
    ...
    docker_start_or_run mc-es -p 9200:9200 -p 9300:9300 elasticsearch:"$ES_VERSION" -Dnetwork.host=0.0.0.0
    docker_start_or_run mc-kibana -e "ELASTICSEARCH_URL=http://$DOCKER_MACHINE_IP:9200" -p 5601:5601 kibana
