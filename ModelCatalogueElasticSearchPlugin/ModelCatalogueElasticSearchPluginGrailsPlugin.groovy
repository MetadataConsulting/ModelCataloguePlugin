...
class ModelCatalogueElasticSearchPluginGrailsPlugin {
    ...
    def title = "Model Catalogue ElasticSearch Plugin" // Headline display name of the plugin
    def author = "Vladimir Orany"
    def authorEmail = "vladimir@orany.cz"
    def description = '''\
ElasticSearch support for Model Catalogue
'''

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/model-catalogue-elasticsearch-plugin"
