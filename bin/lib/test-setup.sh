...
if [[ "$TRAVIS" != "" ]] ; then
    echo -e "\nTest Results will be available at\n\nhttp://mc-travis-results.orany.cz.s3.amazonaws.com/index.html?prefix=MetadataConsulting/ModelCataloguePlugin/$TRAVIS_BUILD_NUMBER/$TRAVIS_JOB_NUMBER/home/travis/reports/\n\n"
