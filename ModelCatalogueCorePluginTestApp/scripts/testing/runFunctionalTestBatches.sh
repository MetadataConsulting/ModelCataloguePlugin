...
declare -a SPEC_BATCHES_ARRAY=( "MaxOccursShowsInHistorySpec VerifyMinOccursCanBeZeroSpec CheckCreateElementFromClassWizardSpec AddAndRemoveManyDataElementsSpec NewDraftEditFromImportedModelsAreUpdatedSpec GrantRoleCuratorSpec"
"CannotCreateDataElementWithUnauthorizedDataTypeSpec CheckDataTypeAddedToNewVersionSpec ValidateValueAgainstDataTypeSpec VerifySupervisorCanActionSettingsSpec VerifyViewerCannotAccessFactActionsSpec AdminUserCannotDeleteFinalizedItemsSpec"
"VerifyCuratorCannotDeleteFinalizedDataModelSpec CuratorCannotCreateClassInFinalizedModelSpec AdminCanCreateModelAndPolicySpec DisableUserSpec CheckAdminCanDeleteImportedModelSpec VerifyRegularUserCanSeeApiKeySpec"
"CuratorCanCreateANewDataClassSpec UserCannotEditReadOnlyDataModelSpec CuratorCannotEditFinalizedModelSpec CuratorCanImportFinalizedDataModelSpec CuratorWithAdminCanDeleteClassInDraftModelSpec CannotAddElementToFinalizedModelSpec"
"CannotAddDataElementsToFinalizedDataModelSpec CanCreateDataElementAndCloneDataTypeSpec CanSelectPoliciesWhileCreatingDataModelSpec CanImportDataModelSpec CanCreateDataTypeSpec UnableToImportIfReadAccessSpec"
"AbleToNavigateToOldVersionOfAModelThroughTreeSpec CannotDeleteFinalizedDataModelSpec UserCanFinalizeDataModelSpec HistoryIsPopulatedAccordingToModelActivitySpec ImportAndRemoveDataModelReflectsInHistorySpec ImportXmlAndExcelDataSpec"
"CanCreateDataTypeFromCreateDataElementWizardSpec UserIsAbleToDownloadAnAssetSpec CuratorCanGenerateSuggestionsUsingMappingUtilitySpec VersionVerificationSpec CheckDataModelPolicyTagSpec CheckDataModelPoliciesSpec"
