#= require catalogueElementTreeview.tpl.coffee
angular.module('mc.core.ui.catalogueElementTreeview').directive 'catalogueElementTreeview',  [-> {
    restrict: 'E'
    replace: true
    scope:
      element: '=?'
    ...
    template: 'modelcatalogue/core/ui/catalogueElementTreeview.html'

    controllerAs: 'treeview'

    controller: ($scope, enhance, $stateParams, $rootScope, $element, $attrs, rx, TreeviewNodeFactory, DescendPath) ->
      "ngInject"
      selected = undefined
      treeview = @
