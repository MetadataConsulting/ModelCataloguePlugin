angular.module('modelcatalogue.core.ui.imports.modalPromptNewCatalogueXmlImport', ['mc.util.messages', 'modelcatalogue.core.ui.imports.importCtrl']).config ['messagesProvider', (messagesProvider)->
