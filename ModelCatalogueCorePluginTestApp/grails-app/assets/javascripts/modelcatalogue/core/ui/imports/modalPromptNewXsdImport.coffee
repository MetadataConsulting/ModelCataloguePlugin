angular.module('modelcatalogue.core.ui.imports.modalPromptNewXsdImport', ['mc.util.messages', 'modelcatalogue.core.ui.imports.importCtrl']).config ['messagesProvider', (messagesProvider)->
