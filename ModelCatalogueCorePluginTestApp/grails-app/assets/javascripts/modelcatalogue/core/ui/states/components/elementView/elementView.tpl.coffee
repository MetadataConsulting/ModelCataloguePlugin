angular.module('modelcatalogue.core.ui.states.components.elementView.html', ['mc.core.ui.propertiesPane', 'mc.core.ui.simpleObjectEditor', 'ui.bootstrap', 'ngSanitize']).run [ '$templateCache', ($templateCache) ->
    $templateCache.put 'modelcatalogue/core/ui/elementView/simple-object-editor.html', '''
        <div>
    ...
    $templateCache.put 'modelcatalogue/core/ui/elementView/simple-object-editor-for-enumerations.html', '''
        <div>
          <simple-object-editor object="tab.value" title="Key" value-title="Value"></simple-object-editor>
          <div class="row">
            <div class="col-md-12">
    ...
    '''
    $templateCache.put 'modelcatalogue/core/ui/elementView/ordered-map-editor.html', '''
        <div>
    ...
    $templateCache.put 'modelcatalogue/core/ui/elementView/metadata-editor.html', '''
        <div>
    ...
    $templateCache.put 'modelcatalogue/core/ui/elementView/ordered-map-editor-for-enumerations.html', '''
        <div>
    ...
    $templateCache.put 'modelcatalogue/core/ui/elementView/properties-pane-for-enumerations.html', '''
    ...
    $templateCache.put 'modelcatalogue/core/ui/elementView/properties-pane-for-properties.html', '''
        <properties-pane id="{{tab.name}}-props" item="tab.value" properties="tab.properties"></properties-pane>
    '''

    $templateCache.put 'modelcatalogue/core/ui/elementView/properties-pane.html', '''
      <properties-pane id="{{tab.name}}-objects" item="tab.value" properties="tab.properties" title="Key" value-title="Value"></properties-pane>
    '''

    $templateCache.put 'modelcatalogue/core/ui/elementView/decorated-list.html', '''
    ...
    $templateCache.put 'modelcatalogue/core/ui/elementView/relationship-details.html', '''
