angular.module('mc.core.ui.bs.modalPromptAssetEdit', ['mc.util.messages', 'ngFileUpload', 'mc.core.ui.bs.withClassificationCtrlMixin', 'mc.util.ui.actions']).config ['messagesProvider', (messagesProvider)->
