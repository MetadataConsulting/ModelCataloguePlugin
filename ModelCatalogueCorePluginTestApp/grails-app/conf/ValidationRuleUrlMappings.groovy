...
class ValidationRuleUrlMappings {
    ...
    static mappings = {
        ...
        "/api/modelCatalogue/core/validationRule/$id/availableReportDescriptors"(controller: 'validationRule', action: 'availableReportDescriptors', method: HttpMethod.GET)
