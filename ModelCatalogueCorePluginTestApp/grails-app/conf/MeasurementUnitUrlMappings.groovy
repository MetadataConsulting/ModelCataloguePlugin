...
class MeasurementUnitUrlMappings {
    ...
    static mappings = {
        ...
        "/api/modelCatalogue/core/measurementUnit/$id/availableReportDescriptors"(controller: 'measurementUnit', action: 'availableReportDescriptors', method: HttpMethod.GET)
