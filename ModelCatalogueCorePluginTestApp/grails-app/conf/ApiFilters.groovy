...
class ApiFilters {
    ...
    def filters = {
        legacy(controller:'*', action:'*', controllerExclude: 'genomics', actionExclude: 'changelogDoc|inventoryDoc|excelExporterSpreadsheet|gridSpreadsheet|inventorySpreadsheet') {
            before = {
