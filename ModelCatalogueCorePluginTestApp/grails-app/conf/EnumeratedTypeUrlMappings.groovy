...
class EnumeratedTypeUrlMappings {
    ...
    static mappings = {
        ...
        "/api/modelCatalogue/core/enumeratedType/$id/availableReportDescriptors"(controller: 'enumeratedType', action: 'availableReportDescriptors', method: HttpMethod.GET)
