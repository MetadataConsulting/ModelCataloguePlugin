...
modelcatalogue.defaults.relationshiptypes =  [
    ...
    [name: "favourite",
     ...
     searchable: true],
    [name: "subscription",
     sourceToDestination: "subscriptions",
     destinationToSource: "subscribedTo",
     sourceClass: DataModel,
     destinationClass: User,
     system: true,
     sourceToDestinationDescription: "A Data Model can have a number of users who are subscribed",
     destinationToSourceDescription: "Users can be subscribed to a number of data models",
     searchable: true],
    [name: "import",
