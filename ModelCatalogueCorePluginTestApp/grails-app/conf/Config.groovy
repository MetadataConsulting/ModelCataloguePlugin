...
modelcatalogue.defaults.relationshiptypes =  [
    [name: "containment", sourceToDestination: "contains", destinationToSource: "contained in", sourceClass: DataClass, destinationClass: DataElement, rule: '''
            ...
            return true
        ''', versionSpecific: true, sourceToDestinationDescription: "A Data Class can contain multiple Data Elements. Contained Data Elements are finalized when the Class is finalized.", destinationToSourceDescription: "A Data Element can be contained in multiple Data Classes. When a new draft of a Data Element is created, then drafts for all containing Data Classes are created as well."],
    ...
    [name: "attachment", sourceToDestination: "has attachment of", destinationToSource: "is attached to", sourceClass: CatalogueElement, destinationClass: Asset, sourceToDestinationDescription: "You can attach uploaded Assets to any Catalogue Element.", destinationToSourceDescription: "Any uploaded asset can be attached to multiple Catalogue Elements."],
    [name: "hierarchy", sourceToDestination: "parent of", destinationToSource: "child of", sourceClass: DataClass, destinationClass: DataClass, versionSpecific: true, sourceToDestinationDescription: "Class can contain (be parent of) multiple Classes. Child Classes are finalized when parent Class is finalized,", destinationToSourceDescription: "Class can be contained (be child Class) in multiple Classes. When draft is created for child Class drafts for parent Classes are created as well."],
    ...
    [name: "origin", sourceToDestination: "is origin for", destinationToSource: "is cloned from", sourceClass: CatalogueElement, destinationClass: CatalogueElement, rule: "isSameClass()", system: true, versionSpecific: true, sourceToDestinationDescription: "Any Element can be cloned from a single Element of the same type.", destinationToSourceDescription: "Any Element can be origin for multiple cloned Elements of the same type in different Data Models."],
    [name: "relatedTo", sourceToDestination: "related to", destinationToSource: "related to", sourceClass: CatalogueElement, destinationClass: CatalogueElement, bidirectional: true, sourceToDestinationDescription: "Any Element can be related to multiple Elements. This relationship has no specific meaning, but may carry metadata to further specify it."],
    [name: "synonym", sourceToDestination: "is synonym for", destinationToSource: "is synonym for", sourceClass: CatalogueElement, destinationClass: CatalogueElement, bidirectional: true, rule: "isSameClass()", sourceToDestinationDescription: "Any Element can be a synonym of multiple Elements of the same type having similar meaning."],
    ...
    [name: "import", sourceToDestination: "imports", destinationToSource: "is imported by", sourceClass: DataModel, destinationClass: DataModel, sourceToDestinationDescription: "Data Model can import other Data Model to reuse Elements declared there.", destinationToSourceDescription: "A Data Model can be imported by many other Data Models so they can reuse the Catalogue Elements defined within it."],
    ...
    [name: "involvedness", destinationToSource: "is involved in", sourceToDestination: "involves", sourceClass: ValidationRule, destinationClass: DataElement, versionSpecific: true, destinationToSourceDescription: "A Data Element can be involved in multiple Validation Rules", sourceToDestinationDescription: "A Validation Rule can involve multiple Data Elements"],
    [name: "tag", sourceToDestination: "tags", destinationToSource: "is tagged by", sourceClass: Tag, destinationClass: DataElement, versionSpecific: false, sourceToDestinationDescription: "A Tag may tag multiple Data Elements", destinationToSourceDescription: "Data Elements can be tagged by multiple Tags"],
]
