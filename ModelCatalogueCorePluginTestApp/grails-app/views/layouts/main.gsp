        ...
        <li role="presentation" class="dropdown navbar-right">
            ...
            <ul class="dropdown-menu">
                <sec:ifAllGranted roles="ROLE_SUPERVISOR">
                    ...
                    <li><a href="${g.createLink(controller: 'dataModelPermission', action: 'index')}" id="dataModelPermission-link"><i class="fas fa-lock"></i> <g:message code="nav.dataModelPermission" default="Data Model ACL"/></a></li>
                </sec:ifAllGranted>
