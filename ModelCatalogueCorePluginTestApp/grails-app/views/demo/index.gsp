                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown" ui-sref-active="active">
                        ...
                        <ul class="dropdown-menu">
                            <li ui-sref-active="active"><a id="modelLink" ui-sref="mc.resource(resource: 'model')">Models</a></li>
                            <li ui-sref-active="active"><a id="dataElementLink" ui-sref="mc.resource(resource: 'dataElement')">Data Elements</a></li>
                            <li ui-sref-active="active"><a id="valueDomainLink" ui-sref="mc.resource(resource: 'valueDomain')">Value Domains</a></li>
                            <li ui-sref-active="active"><a id="conceptualDomainLink" ui-sref="mc.resource(resource: 'conceptualDomain')">Conceptual Domains</a></li>
                            <li ui-sref-active="active"><a id="dataTypeLink" ui-sref="mc.resource(resource: 'dataType')">Data Types</a></li>
                        </ul>
                    </li>
                    <li ui-sref-active="active" ><a id="relationshipTypeLink" ui-sref="mc.resource(resource: 'relationshipType')">Relationship Types</a></li>
                </ul>
