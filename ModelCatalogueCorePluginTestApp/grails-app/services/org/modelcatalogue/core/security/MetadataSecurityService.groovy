...
class MetadataSecurityService {
    ...
    public static final List CSV_TRANSFORMATION_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/csvTransformation/*/transform", [MetadataRoles.ROLE_USER], HttpMethod.POST],
    ]
    ...
    public static final List USER_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/user/validate", 'isAuthenticated()', HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*", [MetadataRoles.ROLE_USER], HttpMethod.GET],
            ["/api/modelCatalogue/core/user/*/availableReportDescriptors", [MetadataRoles.ROLE_USER], HttpMethod.GET],
            ...
            ["/api/modelCatalogue/core/user/apikey", [MetadataRoles.ROLE_USER], HttpMethod.POST],
