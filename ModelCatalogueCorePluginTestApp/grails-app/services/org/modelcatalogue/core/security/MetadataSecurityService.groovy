...
class MetadataSecurityService {
    ...
    public static final List<List> ASSET_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/asset/*/finalize", 'isAuthenticated()', HttpMethod.POST],
    ...
    public static final List<List> DATA_ELEMENTS_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataElement/*/finalize", 'isAuthenticated()', HttpMethod.POST],
    ...
    public static final List<List> CATALOGUE_ELEMENT_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> DATA_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataType/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> ENUMERATED_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> REFERENCE_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/referenceType/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> PRIMITIVE_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/primitiveType/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> TAG_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/tag/*/finalize", 'isAuthenticated()', HttpMethod.POST],
    ...
    public static final List<List> VALIDATION_RULE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/validationRule/*/finalize", 'isAuthenticated()', HttpMethod.POST],
    ...
    public static final List<List> MODEL_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/model/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> CLASSIFICATION_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/classification/*/finalize",'isAuthenticated()',HttpMethod.POST],
    ...
    public static final List<List> USER_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/user/*/finalize", MetadataRolesUtils.roles('SUPERVISOR'), HttpMethod.POST],
    ...
    public static final List<List> MEASUREMENT_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/finalize",'isAuthenticated()',HttpMethod.POST],
