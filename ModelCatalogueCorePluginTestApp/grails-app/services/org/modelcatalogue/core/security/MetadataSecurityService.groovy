...
class MetadataSecurityService {
    ...
    public static final List DATAIMPORTCREATE_URL_MAPPINGS = [
        ["/dataImport/obo",  MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
        ["/dataImport/dsl",  MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
        ["/dataImport/excel",  MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
    ...
    public static final List REINDEXCATALOGUE_MAPPINGS = [
            ["/reindexCatalogue/index",  MetadataRoles.ROLE_SUPERVISOR, HttpMethod.GET],
    ]

    public static final List LASTSEEN_URL_MAPPINGS = [
            ["/lastSeen/index",  MetadataRoles.ROLE_SUPERVISOR, HttpMethod.GET],
    ]
    ...
    public static final List MAPPINGS_SUGGESTIONS_URL_MAPPINGS = [
            ["/mappingsuggestions",  MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/mappingsuggestions",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/mappingsuggestions/reject",  MetadataRoles.ROLE_CURATOR ,HttpMethod.POST],
            ["/mappingsuggestions/approve",  MetadataRoles.ROLE_CURATOR ,HttpMethod.POST],
    ]

    public static final List MODEL_CATALOGUE_GENOMICS_URL_MAPPINGS = [
            ["/api/modelCatalogue/core/genomics/imports/upload", MetadataRoles.ROLE_CURATOR ,HttpMethod.POST],
    ...
    public static final List MODEL_CATALOGUE_AUDIT_PLUGIN_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/change/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List ASSET_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/asset/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/asset/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/asset/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/upload", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
    ...
    public static final List DATA_ELEMENTS_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataElement/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataElement/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataElement/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataElement/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataElement/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataElement/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List DATA_CLASS_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataClass/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataClass/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataClass/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/inventoryDoc", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/dataClass/*/classificationChangelog", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
    ...
    public static final List CATALOGUE_ELEMENT_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/catalogueElement/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/catalogueElement/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/catalogueElement/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List DATA_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataType/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataType/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataType/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataType/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List ENUMERATED_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/setDeprecated", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/enumeratedType/validate", 'isAuthenticated()', HttpMethod.POST],
            ["/api/modelCatalogue/core/enumeratedType/*", 'isAuthenticated()', HttpMethod.GET],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/enumeratedType/*/outgoing/*",MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/enumeratedType/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List REFERENCE_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/referenceType/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/referenceType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/referenceType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/referenceType/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/referenceType/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/referenceType/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List DATA_MODEL_POLICY_MAPPINGS = [
            ["/api/modelCatalogue/core/dataModelPolicy", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/dataModelPolicy", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataModelPolicy/search", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/dataModelPolicy/search/*", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/dataModelPolicy/*/validate", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataModelPolicy/validate", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataModelPolicy/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/dataModelPolicy/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.PUT],
            ["/api/modelCatalogue/core/dataModelPolicy/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ]
    ...
    public static final List PRIMITIVE_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/primitiveType/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/primitiveType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/primitiveType/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/primitiveType/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/primitiveType/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/primitiveType/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List CSV_TRANSFORMATION_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/csvTransformation/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ["/api/modelCatalogue/core/csvTransformation/*/transform", 'isAuthenticated()', HttpMethod.POST],
    ]
    ...
    public static final List RELATIONSHIP_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/relationshipType", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ...
            ["/api/modelCatalogue/core/relationshipType/validate", 'isAuthenticated()', HttpMethod.POST],
            ["/api/modelCatalogue/core/relationshipType/*", 'isAuthenticated()', HttpMethod.GET],
            ["/api/modelCatalogue/core/relationshipType/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.PUT],
            ["/api/modelCatalogue/core/relationshipType/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.DELETE],
    ...
    public static final List TAG_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/tag/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/tag/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/tag/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/tag/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/tag/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/tag/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List VALIDATION_RULE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/validationRule/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/validationRule/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/validationRule/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/validationRule/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/validationRule/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/validationRule/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List BATCH_MAPPINGS = [
            ...
            ["/batch/all", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/batch/create", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/batch/generateSuggestions", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/batch/archive", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],


            ["/api/modelCatalogue/core/batch", MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/batch", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/batch/search/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/batch/search/",  MetadataRoles.ROLE_CURATOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/batch/*/validate", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ...
            ["/api/modelCatalogue/core/batch/*/actions/*/dismiss", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/batch/*/actions/*/reactivate", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/batch/*/actions/*/run", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/batch/*/actions/*/parameters", MetadataRoles.ROLE_CURATOR, HttpMethod.PUT],

            ["/api/modelCatalogue/core/batch/*/actions/*/dependsOn", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ["/api/modelCatalogue/core/batch/*/actions/*/dependsOn", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
    ]
    ...
    public static final List MODEL_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/model/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/model/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/model/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/model/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/model/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/model/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List CLASSIFICATION_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/classification/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/classification/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/classification/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/classification/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/classification/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/classification/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
    ...
    public static final List DATA_MODEL_MAPPINGS = [
            ...
            ["/dataModel/basicViewChildrenData/*/*", 'isAuthenticated()', HttpMethod.GET],
            ...
            ["/api/modelCatalogue/core/dataModel/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataModel/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataModel/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataModel/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/dataModel/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataModel/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataModel/*/newVersion", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
    ...
    public static final List USER_MAPPINGS = [
            ["/api/modelCatalogue/core/user", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/user", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ...
            ["/api/modelCatalogue/core/user/validate", 'isAuthenticated()', HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*", 'isAuthenticated()', HttpMethod.GET],
            ["/api/modelCatalogue/core/user/*/availableReportDescriptors", 'isAuthenticated()', HttpMethod.GET],
            ["/api/modelCatalogue/core/user/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.PUT],
            ["/api/modelCatalogue/core/user/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/user/*/outgoing/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/outgoing/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.DELETE],
            ["/api/modelCatalogue/core/user/*/outgoing/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.PUT],
            ...
            ["/api/modelCatalogue/core/user/*/incoming/*",  MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/incoming/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/user/*/mapping/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/user/*/archive", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/restore", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/clone/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/merge/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/user/current",'permitAll', HttpMethod.GET],
            ["/api/modelCatalogue/core/user/current",'isAuthenticated()',HttpMethod.GET],
            ["/api/modelCatalogue/core/user/classifications", MetadataRoles.ROLE_SUPERVISOR,HttpMethod.POST],
            ["/api/modelCatalogue/core/user/lastSeen", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.GET],
            ["/api/modelCatalogue/core/user/apikey", 'isAuthenticated()', HttpMethod.POST],
            ...
            ["/api/modelCatalogue/core/user/*/enable", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/disable", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/user/*/role/*", MetadataRoles.ROLE_SUPERVISOR, HttpMethod.POST],
    ]
    ...
    public static final List MEASUREMENT_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/measurementUnit/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/measurementUnit/*/outgoing/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/incoming/*",  MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
            ["/api/modelCatalogue/core/measurementUnit/*/incoming/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/mapping/*", MetadataRoles.ROLE_CURATOR, HttpMethod.DELETE],
...
//      requestmapGormService.createRequestmapIfMissing('/api/modelCatalogue/core/relationshipTypes/**', 'ROLE_ADMIN')
    ...
    private void secureModelCatalogueCorePluginUrlMappings() {
        secureMappings([
            ["/api/modelCatalogue/core/forms/generate/*", 'isAuthenticated()', HttpMethod.GET],
            ["/api/modelCatalogue/core/forms/preview/*", 'isAuthenticated()', HttpMethod.GET],
            ["/catalogue/upload", MetadataRoles.ROLE_CURATOR, HttpMethod.POST],
