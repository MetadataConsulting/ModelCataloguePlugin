...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B73D2D48_B9EB_408C_90B3_6B5BBD20A79C START WITH 171 BELONGS_TO_TABLE;   
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_986BF911_1ED6_48FD_8111_65FBF1F31C4B START WITH 35865 BELONGS_TO_TABLE; 
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_FA1F68A8_BD29_4CC2_884B_0CE6B5D946F4 START WITH 1509 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_CEF088DF_D7E8_4876_9297_5A82B37AA2D0 START WITH 170 BELONGS_TO_TABLE;   
...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_48CEAAAF_2BEA_4F58_B74D_43F8F7F66F39 START WITH 18944 BELONGS_TO_TABLE; 
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A99F4BEF_4333_49FF_AB4B_73A6036EFBC1 START WITH 7527 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_928C5C84_0376_43E0_9024_0058AD5666D3 START WITH 1417 BELONGS_TO_TABLE;  
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.ACL_CLASS;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.ACL_ENTRY;
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.ACL_OBJECT_IDENTITY;      
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.ACL_SID;  
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.CATALOGUE_ELEMENT;        
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DATA_CLASS;               
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DATA_MODEL;               
...
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.EXTENSION_VALUE;          
