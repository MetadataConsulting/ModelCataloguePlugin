...
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_B73D2D48_B9EB_408C_90B3_6B5BBD20A79C START WITH 146 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A30922A4_033F_4C06_AC65_CDDA6C684D18 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_FF10B2D8_8075_42FC_9B50_3B03281A4B70 START WITH 776 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_5C09A253_1193_42F7_8A18_0E5D39EF5E5F START WITH 66 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_EE1CCD12_5ABA_44B9_841B_EB946A1AF8E4 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_986BF911_1ED6_48FD_8111_65FBF1F31C4B START WITH 9431 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_28AD9A6B_6861_4FEB_B19E_1C5E409E419E START WITH 402 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_02C1CBE2_AC91_4491_BBDD_52943DB39F47 START WITH 72 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_58A3A240_EE94_4CB6_A3AA_44C7A1DED7B3 START WITH 1 BELONGS_TO_TABLE;     
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_FA1F68A8_BD29_4CC2_884B_0CE6B5D946F4 START WITH 1306 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_CEF088DF_D7E8_4876_9297_5A82B37AA2D0 START WITH 145 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_AB101B45_C113_477C_864A_0A77F1AA9C42 START WITH 713 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_9DB6221B_ADD8_42AD_84F2_D2AB5ECF8565 START WITH 36886 BELONGS_TO_TABLE; 
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_1F290E42_6C97_4A53_B1A2_266886AC63E0 START WITH 62 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_62E61E11_5898_4FBA_92E2_90CF81DDDF5A START WITH 3044 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_AFD576D2_5FA8_4B88_949D_0E8E8EB21120 START WITH 17 BELONGS_TO_TABLE;    
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_48CEAAAF_2BEA_4F58_B74D_43F8F7F66F39 START WITH 14778 BELONGS_TO_TABLE; 
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A99F4BEF_4333_49FF_AB4B_73A6036EFBC1 START WITH 4802 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_928C5C84_0376_43E0_9024_0058AD5666D3 START WITH 1222 BELONGS_TO_TABLE;  
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_F84A0490_6AE9_4FDB_9712_87B6144B0C60 START WITH 369 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_D2222819_E18D_4DE8_A51B_6FF4F1051220 START WITH 244 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A026FE1B_84B2_4EDF_8553_641B5DABD8BA START WITH 284 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_1B50A1AE_487D_4735_A2C9_322B1D071584 START WITH 68 BELONGS_TO_TABLE;    
...
-- 717 +/- SELECT COUNT(*) FROM PUBLIC."change";               
...
-- 11 +/- SELECT COUNT(*) FROM PUBLIC.ACL_ENTRY;               
...
-- 11 +/- SELECT COUNT(*) FROM PUBLIC.ACL_OBJECT_IDENTITY;     
...
-- 252 +/- SELECT COUNT(*) FROM PUBLIC.CATALOGUE_ELEMENT;      
...
-- 11 +/- SELECT COUNT(*) FROM PUBLIC.DATA_MODEL;              
...
-- 10 +/- SELECT COUNT(*) FROM PUBLIC.DATA_TYPE;               
...
-- 230 +/- SELECT COUNT(*) FROM PUBLIC.RELATIONSHIP;           
