package org.modelcatalogue.core.regression.lowpriority
...
class CloneAanClassIntoAnotherModelSpec extends AbstractModelCatalogueGebSpec{
    ...
    def "login to model catalogue and create a data model"() {
        ...
        and:'fill the form '
        fill Common.nameLabel with 'TESTING_DATA_MODEL'
        fill Common.modelCatalogueId with 'MET-00233'
    ...
    def "clone a data class in to another data model"() {
        ...
        fill search with 'TESTING_DATA_MODEL' and Common.pick first Common.item
       ...
       Thread.sleep(TIME_TO_REFRESH_SEARCH_RESULTS)
        ...
        then:
        check Common.rightSideTitle contains 'MET-523.M1'
    }
