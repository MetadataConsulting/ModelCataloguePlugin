...
class AddDataInToFavouritesSpec extends AbstractModelCatalogueGebSpec {
    ...
    def "navigate to favourites"() {
     ...
     def "add data to favourite"() {
         ...
         then:
         check Common.modalHeader is "Add to Favourites"

         when:
         fill searchField with 'Ovarian Cancer (NHIC 0.0.1)' and Common.pick first Common.item
    ...
    def "remove favourite data model"() {
        ...
        then:
        check Common.rightSideTitle contains 'Cancer'
