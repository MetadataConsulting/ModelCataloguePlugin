...
@Stepwise
class MET1619_CreateNewVersionFromFinalisedToDraftSpec extends AbstractModelCatalogueGebSpec {
    ...
    def "login to model catalogue and create data model"() {
        ...
        and:'fill the form '
        fill Common.nameLabel with 'TESTING_DATA_MODEL_NEW_VERSION'
        ...
        then:
        check Common.rightSideTitle contains 'TESTING_DATA_MODEL_NEW_VERSION'
    }
    ...
    def "finalized the data model and create new version"() {
        ...
        fill Common.modelCatalogueId with 'ME-34567'
        ...
        then:
        check Common.rightSideTitle contains'TESTING_CLASS'
    }
