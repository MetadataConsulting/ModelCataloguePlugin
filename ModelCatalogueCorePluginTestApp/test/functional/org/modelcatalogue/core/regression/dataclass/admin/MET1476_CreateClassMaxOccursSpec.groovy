...
@Stepwise
class MET1476_CreateClassMaxOccursSpec extends AbstractModelCatalogueGebSpec{
    ...
    def "login to model catalogue and create a data model"() {
        ...
        and:'fill the form '
        fill Common.nameLabel with 'TESTING_DATA_MODEL_MAX'
        fill Common.modelCatalogueId with 'MET-00263'
        ...
        then:
        check Common.rightSideTitle contains 'TESTING_DATA_MODEL'
    }
    ...
    def "create data class and add occurrence"() {
        ...
        then:
        check Common.rightSideTitle is 'Active Data Classes'

        when:
        click Common.create

        then:'check the title of the page'
        check Common.modalHeader is 'Data Class Wizard'

        when: 'fill the data class form'
        fill Common.nameLabel with'TESTING_CLASS'
        fill Common.modelCatalogueId with 'ME-345'
        fill Common.description with 'THIS IS MY TESTING DATA CLASS'
    ...
    def "create a data class without occurrence"() {
        ...
        when: 'fill the data class form'
        fill Common.nameLabel with'TESTING'
        fill Common.modelCatalogueId with 'ME-322'
        fill Common.description with 'THIS IS MY TESTING DATA CLASS'
        Thread.sleep(TIME_TO_REFRESH_SEARCH_RESULTS)
    ...
    def "verify that max occurrence appears into history"() {
        ...
        fill search with  'TESTING_CLASS' and Common.pick first Common.item
        ...
        and:
        click Common.modalPrimaryButton // TODO Fails here
    ...
    def "delete data model"() {
        ...
        then:
        check Common.rightSideTitle contains 'TESTING_DATA_MODEL_MAX'
