...
class CreateDataTypeAndSelectSubsetSpec extends AbstractModelCatalogueGebSpec {
    ...
    def "fill the create data type form"() {
        when:
        fill Common.nameLabel with "TESTING_DATA_TYPE_SUBSET"

        fill Common.modelCatalogueId with "MET-089"

        fill Common.description with "my description of data type${System.currentTimeMillis()}"
