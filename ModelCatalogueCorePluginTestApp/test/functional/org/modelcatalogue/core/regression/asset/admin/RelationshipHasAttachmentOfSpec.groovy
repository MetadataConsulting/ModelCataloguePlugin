package org.modelcatalogue.core.regression.asset.admin
...
class RelationshipHasAttachmentOfSpec extends AbstractModelCatalogueGebSpec{
    ...
    def "navigate back to data model"() {
        ...
        then:
        check Common.rightSideTitle contains 'Test 3'
    }
    ...
    def "select based on,destination and create relationship"() {
        ...
        fill search with "example TESTING" and Common.pick first Common.item
