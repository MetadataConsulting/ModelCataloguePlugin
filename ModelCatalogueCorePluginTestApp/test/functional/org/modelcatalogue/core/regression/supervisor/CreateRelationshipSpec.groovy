package org.modelcatalogue.core.regression.supervisor
...
class CreateRelationshipSpec extends AbstractModelCatalogueGebSpec {
    ...
    def "login to model catalogue and navigate to data model"() {
        ...
        select 'Test 1'
        then:
        check Common.rightSideTitle contains 'Test 1'
    }
    ...
    def "create relationship"() {
        ...
        when:
        fill search with text and Common.pick first Common.item
        Thread.sleep(2000l)
