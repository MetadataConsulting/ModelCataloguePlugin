...
class ModelCatalogueAuditPluginUrlMappings {
    ...
    static mappings = {
        ...
        def catalogueElements = ['asset', 'dataElement', 'dataModel', 'catalogueElement', 'dataType', 'enumeratedType', 'measurementUnit', 'primitiveType','referenceType', 'user', 'dataClass', 'validationRule']
