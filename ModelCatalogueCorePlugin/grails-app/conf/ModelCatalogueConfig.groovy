...
modelcatalogue.defaults.relationshiptypes =  [
        ...
        [name: 'base', sourceToDestination: 'is base for', destinationToSource: 'is based on', sourceClass: CatalogueElement, destinationClass: CatalogueElement, rule: "sameClass", sourceToDestinationDescription: "Any catalogue element can be base for multiple elements of the same type.", destinationToSourceDescription: "Any catalogue element can be based on multiple elements of the same type. Value domains will first use rules of the base value domains and than their owns when validating input values."],
        ...
        [name: "supersession", sourceToDestination: "superseded by", destinationToSource: "supersedes", sourceClass: CatalogueElement, destinationClass: CatalogueElement, rule: "sameClass", system: true, versionSpecific: true, sourceToDestinationDescription: "Any element can have multiple previous versions which are elements of the same type.", destinationToSourceDescription: "Any element can be previous version (supersede) multiple elements of the same type."],
        [name: "origin", sourceToDestination: "is origin for", destinationToSource: "is cloned from", sourceClass: CatalogueElement, destinationClass: CatalogueElement, rule: "sameClass", system: true, versionSpecific: true, sourceToDestinationDescription: "Any element can be cloned from single element of the same type.", destinationToSourceDescription: "Any element can be origin for multiple cloned elements of the same type in different data models."],
