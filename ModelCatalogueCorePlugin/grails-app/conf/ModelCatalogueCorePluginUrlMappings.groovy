...
class ModelCatalogueCorePluginUrlMappings {
	...
	static mappings = {
        ...
        for (String controllerName in allElements) {
            ...
            "/api/modelCatalogue/core/$controllerName/$id/relationships/search/$type?" (controller: controllerName, action: "searchRelationships", method: HttpMethod.GET)
            ...
            "/api/modelCatalogue/core/$controllerName/$id/outgoing/search/$type?" (controller: controllerName, action: 'searchOutgoing', method: HttpMethod.GET)
            ...
            "/api/modelCatalogue/core/$controllerName/$id/incoming/search/$type?" (controller: controllerName, action: 'searchIncoming', method: HttpMethod.GET)
