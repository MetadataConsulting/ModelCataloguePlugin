...
class ModelCatalogueCorePluginUrlMappings {
	...
	static mappings = {
        ...
        def catalogueElements = ['asset', 'dataElement', 'dataClass', 'catalogueElement', 'dataType', 'enumeratedType', 'measurementUnit', 'valueDomain', 'user', 'dataModel', 'classification', 'model']
        ...
        for (String elementName in allElements) {
            ...
            if (controllerName in catalogueElements) {
                ...
                if (controllerName in ['dataModel', 'classification']) {
                    "/api/modelCatalogue/core/$elementName/$id/classifies"(controller: controllerName, action: 'classifies', method: HttpMethod.GET)
					...
					"/api/modelCatalogue/core/$elementName/$id/gereportDoc"(controller: controllerName, action: 'gereportDoc', method: HttpMethod.GET)
                }
