angular.module('mc.core.ui.bs.propertiesPane', ['mc.core.ui.propertiesPane']).run [ '$templateCache', ($templateCache) ->
      ...
      <table class="pp-table table">
        ...
        <tbody>
          <tr class="pp-table-property-row" ng-repeat="property in properties" ng-switch="canShow(property.value, item)">
            ...
            <td class="pp-table-property-value col-md-8" ng-switch-when="false">{{evaluateValue(property.value, item)}}</td>
          </tr>
        </tbody>
      </table>
    '''
