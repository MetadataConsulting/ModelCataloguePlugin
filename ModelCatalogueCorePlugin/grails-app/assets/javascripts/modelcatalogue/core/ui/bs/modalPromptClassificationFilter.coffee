        ...
        <div class="modal-body">
            <form role="form">
              ...
              <div class="form-group" ng-hide="filter.unclassifiedOnly">
                <label for="elements">Included Data Models</label>
                <elements-as-tags elements="filter.includes"></elements-as-tags>
                <input id="includes" placeholder="Name or Catalogue ID" ng-model="pending.include" catalogue-element-picker="dataModel" label="el.name" typeahead-on-select="push(pending.include, filter.includes, filter.excludes); pending.include = null" focus-me="true" >
              </div>
              <div class="form-group" ng-hide="filter.unclassifiedOnly">
                <label for="elements">Excluded Data Models</label>
                <elements-as-tags elements="filter.excludes"></elements-as-tags>
                <input id="excludes" placeholder="Name or Catalogue ID" ng-model="pending.exclude" catalogue-element-picker="dataModel" label="el.name" typeahead-on-select="push(pending.exclude, filter.excludes, filter.includes); pending.exclude = null">
              </div>
            </form>
        </div>
