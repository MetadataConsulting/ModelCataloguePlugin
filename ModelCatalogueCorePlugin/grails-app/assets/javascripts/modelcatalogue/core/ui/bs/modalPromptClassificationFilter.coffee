        ...
        <div class="modal-body">
            <form role="form">
              ...
              <div class="form-group" ng-hide="filter.unclassifiedOnly">
                ...
                <input id="elements" placeholder="Name or Catalogue ID" ng-model="pending.include" catalogue-element-picker="classification" label="el.name" typeahead-on-select="push(pending.include, filter.includes, filter.excludes); pending.include = null" focus-me="true" >
              </div>
              <div class="form-group" ng-hide="filter.unclassifiedOnly">
                <label for="elements">Excluded Classifications</label>
                <elements-as-tags elements="filter.excludes"></elements-as-tags>
                <input id="elements" placeholder="Name or Catalogue ID" ng-model="pending.exclude" catalogue-element-picker="classification" label="el.name" typeahead-on-select="push(pending.exclude, filter.excludes, filter.includes); pending.exclude = null">
              </div>
            </form>
        </div>
