angular.module('mc.core.ui.bs.catalogueElementTreeview', ['mc.core.ui.catalogueElementTreeview', 'ui.bootstrap']).run [ '$templateCache', ($templateCache) ->
    ...
    <div class="catalogue-element-treeview-list-container">
      <ul class="catalogue-element-treeview-list-root catalogue-element-treeview-root-list-root catalogue-element-treeview-list" ng-switch="mode">
          ...
          <catalogue-element-treeview-item extra-parameters="{'root': true}" element="item" descend="descend" treeview="treeview" repeat="repeat" ng-repeat="item in list.$$children"></catalogue-element-treeview-item>
          ...
          <catalogue-element-treeview-item extra-parameters="{'root': true}" element="element" descend="descend" treeview="treeview" repeat="repeat" ng-switch-when="element"></catalogue-element-treeview-item>
      </ul>
    </div>
    '''
  ]