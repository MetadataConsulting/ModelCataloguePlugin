...
abstract class AbstractRestfulControllerSpec<T> extends Specification {
    ...
    protected File recordResult(String fixtureName, JSONElement json) {
        File fixtureFile = new File("../ModelCatalogueCorePlugin/test/js/modelcatalogue/core/$controller.resourceName/fixtures/${fixtureName}.gen.fixture.js")
...
(function (window) {
    ...
    def "Show single existing item as JSON"() {
        ...
        json.outgoingRelationships == [count: 1, link: "/${resourceName}/${loadItem1.id}/outgoing"]
        json.incomingRelationships == [count: 0, link: "/${resourceName}/${loadItem1.id}/incoming"]
    ...
    def "Show single existing item as XML"() {
        ...
        xml.outgoingRelationships.@link == "/${resourceName}/${loadItem1.id}/outgoing"
        xml.incomingRelationships.@count == 0
        xml.incomingRelationships.@link == "/${resourceName}/${loadItem1.id}/incoming"
