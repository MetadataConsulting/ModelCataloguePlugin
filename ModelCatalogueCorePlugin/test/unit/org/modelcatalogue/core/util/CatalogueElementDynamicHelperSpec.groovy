...
class CatalogueElementDynamicHelperSpec extends Specification {
    ...
    def "Relationships from #clazz are added to the transients so they are #transients"() {
        ...
        where:
        clazz                   | transients
        TestCatalogueElement1   | [*new ArrayList<String>(CatalogueElement.transients), 'hasContextOf', 'parentOf', 'childOf', 'synonyms']
        TestCatalogueElement2   | [*new ArrayList<String>(CatalogueElement.transients), 'hasContextOf', 'parentOf', 'childOf', 'synonyms', 'b', 'd']
